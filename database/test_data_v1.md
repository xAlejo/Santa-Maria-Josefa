...
BEGIN
    -- Construye el string con el RUT como clave
    EXECUTE format('CREATE USER %I WITH PASSWORD %L', usuario, rut);

	-- Permisos sobre las tablas existentes 
    EXECUTE format(
        'GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO %I', usuario)
END;
...
('5000000000000000003','1000000000000000002','friday','09:00','14:00','',''),
